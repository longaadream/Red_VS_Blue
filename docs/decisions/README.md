...
- [`ADR-0021-deterministic-effect-batch-queues.md`](./ADR-0021-deterministic-effect-batch-queues.md)：只允许 Damage、Heal、Summon、Death 使用确定性 Batch，并以动作级共享 FIFO 调度后续效果（RED-139，已接受）。
