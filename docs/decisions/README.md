...
- [`ADR-0023-colyseus-postgresql-authority.md`](./ADR-0023-colyseus-postgresql-authority.md)：Colyseus 房间权威、PostgreSQL 有界微批耐久、SQLite 离线迁移与 Windows/K8s 双部署边界（RED-159，已接受）。
