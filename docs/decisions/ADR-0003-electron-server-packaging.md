...
- 关联任务：RED-23
- 后续实现合同：RED-44
- 取代决策：[ADR-0021：Windows 自治服务器公开发行、运维与更新边界](./ADR-0021-autonomous-server-operations.md)

> **已取代说明：** 本 ADR 保留为 2026-08-14 内部候选边界的历史记录。RED-140
> 已批准由 ADR-0021 取代该边界；后续自治 Server 发行决策以 ADR-0021 为准，
> 下文历史正文不再改写。
