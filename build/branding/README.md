...
electron-builder.client.json 指定各平台程序图标，将 ICO/PNG 复制到 resources/branding/。electron-client/main.ts 为游戏、服务器连接及管理窗口读取同一图标；Windows AppUserModelID 与客户端 appId 一致。开发态从本目录加载。
