...
const evidence=path.join(root,'docs/qa/RED-192-graph');fs.mkdirSync(evidence,{recursive:true})
try {
  ...
  for (const kind of ['select-piece','damage','heal']) {
  ...
  const report={ok:true,checks:['real canvas node creation/parameters/connections','cycle blocks save','code/JSON synchronization','unknown fields preserved','atomic save and reload','external revision conflict protected'],screenshot:'skill-graph-editor.png'}
