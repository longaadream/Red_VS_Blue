(function (global) {
  ...
  const lessons = [
    ...
    },
    {
      ...
      intro: '最后一局，双方先锋已上场，你从八枚阵容中逐回合部署增援，对方只有四枚残血棋子。把前面学过的操作串起来，亲手取得胜利。对手使用基础练习 AI，可能推进缓慢；本局暂作综合试玩，不计真人战绩，尚未接入正式房间准备和计时。',
    ...
    return Object.assign(lesson, {
      ...
      intro: lesson.intro + ' 教学残局：敌方共 ' + lesson.opponentSize + ' 枚，每枚初始 ' + lesson.opponentHp + ' 点生命（含预备棋子）；技能与胜负按正常规则结算。',
    })
  })
